...
| `tests/input/free_triangle_*` | Custom `free` allocator using selective spilling on a 3-clique. |
...
- `tests/register_alloc_tests.cpp`: white-box unit tests for parsing, web construction,
  interference detection, marker-preserving splitting, free/free-split behavior,
  output serialization, and all allocation variants.
